...
class mySpider(CrawlSpider):
    ...
    def pre_fetch_url(self):
        url_month = 'http://epaperpc.xuanwww.com/epaper/read.do?m=getIssueByMonth'
        payload = {
            'newspaperId': '1',
            'date': '2022-08-20',
        }
        headers = {
            ...
            'Host': 'epaperpc.xuanwww.com',
            'Referer': 'http://epaperpc.xuanwww.com/epaper/read.do?m=i&iid=4764&idate=1_2022-08-20',
    ...
    def start_requests(self):
        ...
        print(paths)
        urls = [urljoin('http://epaperpc.xuanwww.com', item['path']) for item in paths]
        for url in urls:
